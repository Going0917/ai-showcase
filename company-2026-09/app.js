(function () {
        ...
        <div class="diagnostic-body">
          <div class="reality-panel">
            ...
            <div class="reality-stats">
              <div class="reality-stat"><strong class="editable">70+</strong><span class="editable">个核心工作源（群 / 私聊）</span></div>
              <div class="reality-stat wide"><strong class="editable">377–573</strong><span class="editable">单日消息量级</span></div>
      ...
      <div class="starter-proof-layout">
        ...
        <div class="starter-proof-body">
          ...
          <aside class="starter-evidence">
            ...
            <div class="evidence-item"><span class="evidence-no">A</span><div><h3 class="editable">明确信息来源</h3><p class="editable">给 AI 足够上下文：你的 Prompt 记录 ＋ 微信（微信 CLI）＋ 企微（智能助理大圆），其余口头补充。</p></div></div>
      ...
      <div class="leap-layout">
        ...
        <div class="leap-track">
          <article class="leap-node">
            ...
            <p class="editable">诊断次日把画像、习惯与纠错写进 MEMORY.md——系统第一次能记住我是谁。</p>
          </article>
          <article class="leap-node">
          ...
          <article class="leap-node milestone">
            ...
            <p class="editable">微信 CLI 自动扫描工作群 &amp; 客户私聊 → 自动写入新待办、自动更新进展；7/17 首次回填 2222 条群消息。</p>
            <a class="leap-link" href="https://github.com/huohuoer/wechat-cli" target="_blank" rel="noreferrer">github.com/huohuoer/wechat-cli</a>
          </article>
          ...
          <div class="pipeline-left">
            <div class="flow-rail">
              <div class="rail-phase">
                <div class="rail-phase-head"><span class="rail-time">08:00</span><strong class="editable">群扫描 · morning</strong><span class="rail-tool">微信 CLI</span></div>
                <div class="rail-step"><span class="rail-dot"></span><div class="rail-body"><p class="editable">扫 71 群 &amp; 客户私聊 → 粗筛出 a 类对客线索 + b 类四力待办 + 方向信号</p><span class="rail-src editable">来源：圈定工作群 &amp; 客户私聊</span></div></div>
              </div>
              <div class="rail-phase">
                <div class="rail-phase-head"><span class="rail-time">08:30</span><strong class="editable">晨间规划 · Mode I（4 步）</strong></div>
                <div class="rail-step"><span class="rail-dot"></span><div class="rail-body"><p class="editable">读锚点，圈定今天的判断尺子</p><span class="rail-src editable">读取：okr-anchor 四力v2 + Q3 需求待办</span></div></div>
      ...
      <div class="compound-layout">
        ...
        <div class="compound-body">
          <div class="compound-left">
            <div class="flow-rail">
              <div class="rail-phase">
                <div class="rail-phase-head"><span class="rail-time">18:00</span><strong class="editable">群扫描 · evening</strong><span class="rail-tool">微信 CLI</span></div>
                <div class="rail-step"><span class="rail-dot"></span><div class="rail-body"><p class="editable">扫全天增量 → 完成事项、关键变化、新需求</p><span class="rail-src editable">来源：全天工作群 &amp; 客户私聊</span></div></div>
              </div>
              <div class="rail-phase">
                <div class="rail-phase-head"><span class="rail-time">21:00</span><strong class="editable">晚间归档 · Mode J（4 步）</strong></div>
                <div class="rail-step"><span class="rail-dot"></span><div class="rail-body"><p class="editable">日志检查：缺了就反推补建</p><span class="rail-src editable">读取：prompt.md + git commits + 群扫描 morning/evening</span></div></div>
                <div class="rail-step"><span class="rail-dot"></span><div class="rail-body"><p class="editable">按四力分区更新任务状态与 KR 标签</p><span class="rail-src editable">读取：okr-anchor 四力v2 + Q3 需求待办</span></div></div>
      ...
      <div class="five-steps-layout">
        ...
        <div class="five-steps-body">
          ...
          <div class="correction-card">
            <div class="correction-head"><span class="small-label">验收拦下的真实案例 · 华大营养 2/27</span><span class="diag-date editable">掉量 -25%</span></div>
      ...
      <div class="compare-flow-layout">
        ...
        <div class="compare-cards">
          <article class="client-card">
            <div class="client-card-head"><span class="client-stage editable">头部客户</span><h3 class="editable">诺特兰德</h3></div>
            <p class="client-q editable">30+ 直播间 · 近 10 个品线 · 链路覆盖完整</p>
            <p class="client-a editable">人工不可能把数据看齐；AI 先按链路与品线理清全貌，人再判断下一步增长结构。</p>
            <div class="shot-frame client-shot"><img src="assets/shot-ntld-review.png" alt="诺特兰德直播链路深度分析截图" loading="lazy"></div>
            <a class="case-link" href="https://going0917.github.io/ad-guide/creative-benchmark/ntld-review-0706.html" target="_blank" rel="noreferrer">打开复盘报告</a>
          </article>
          <article class="client-card">
            ...
            <a class="case-link" href="https://going0917.github.io/ad-guide/mrdoctor-ad-full-diagnosis-2026-08-27.html" target="_blank" rel="noreferrer">打开竞价诊断</a>
          </article>
        </div>
      </div>`,
      ...
      <div class="stage3-layout">
        ...
        <div class="stage3-evidence">
          ...
          <figure class="stage3-figure">
            ...
            <figcaption><span class="editable">模块五 · 高潜爆品明细视图</span><a class="case-link" href="https://adata.woa.com/bi/artifact/83bac034-e58a-4a50-8651-5eecf84bab29/食品饮料爆品情报周报_2026-06-29.html" target="_blank" rel="noreferrer">打开完整周报</a></figcaption>
          </figure>
        </div>
      ...
      <div class="content-journey-layout">
        ...
        <div class="content-journey-grid">
          <article class="content-stage stage-foundation">
            ...
            <a class="case-link" href="https://doc.weixin.qq.com/doc/w3_AGYAPQbmACgCNPDj1XPUmSvyfQicE?scode=AJEAIQdfAAoTJkxSzEAGYAPQbmACg" target="_blank" rel="noreferrer">打开赛道拆解报告</a>
          </article>
          <article class="content-stage stage-diagnosis">
            ...
            <div class="shot-frame content-stage-shot"><img src="assets/shot-cf-wonderlab.png" alt="万益蓝益生菌素材深度分析：五品牌核心指标对比" loading="lazy"></div>
            <div class="content-stage-detail">
            ...
            <a class="case-link" href="https://going0917.github.io/ad-guide/creative-benchmark/wyl-0629.html" target="_blank" rel="noreferrer">打开万益蓝深度分析</a>
          </article>
          <article class="content-stage stage-forward">
            ...
            <a class="case-link" href="https://going0917.github.io/ad-guide/creative-benchmark/dys-materials-0706.html" target="_blank" rel="noreferrer">打开三伏天节点报告</a>
          </article>
        </div>
        ...
        <div class="livebase-body">
          ...
          <div class="livebase-result">
            ...
            <div class="branch-links dark-links">
              <a class="case-link" href="https://doc.weixin.qq.com/doc/w3_AGYAPQbmACgCNNS1K7OzvRqaPIlbc?scode=AJEAIQdfAAopjs5CkAAGYAPQbmACg" target="_blank" rel="noreferrer">分析框架文档</a>
              <a class="case-link" href="https://doc.weixin.qq.com/doc/w3_AGYAPQbmACgCNX13j0b00Tfu3cUsB?scode=AJEAIQdfAAo5pytsQDAGYAPQbmACg" target="_blank" rel="noreferrer">方法论文档</a>
            </div>
          </div>
        </div>
      ...
      <div class="content-case-layout">
        ...
        <div class="content-case-grid">
          <article class="content-case-card case-diagnosis">
            ...
            <a class="case-link" href="https://doc.weixin.qq.com/doc/w3_AGYAPQbmACgCNl8wtypQbRQ0MmNdX?scode=AJEAIQdfAAoqbtN94BAGYAPQbmACg" target="_blank" rel="noreferrer">打开诊断报告</a>
          </article>
          <article class="content-case-card case-forward">
            <div class="content-case-top"><span>02</span><em class="editable">事前规划 · 清凉节海边直播</em></div>
            <h3 class="editable">特色场景赋能</h3>
            <p class="content-case-role editable">从复盘到预设方案</p>
            <div class="shot-frame content-case-shot"><img src="assets/shot-live-seaside-script.png" alt="华大海边直播话术改造诊断与双直播间差异化话术框架" loading="lazy"></div>
            <div class="content-case-detail">
            ...
            <a class="case-link" href="https://doc.weixin.qq.com/doc/w3_AGYAPQbmACgCNfYI8z1RoRKe8Xr2J?scode=AJEAIQdfAAomJBP8pkAGYAPQbmACg" target="_blank" rel="noreferrer">打开华大话术方案</a>
          </article>
        </div>
      ...
      <div class="evidence-layout">
        ...
        <div class="spill-track">
          <article class="spill-node has-shot">
            ...
            <a class="case-link" href="https://doc.weixin.qq.com/doc/w3_AGYAPQbmACgCNtYqlj4dWR3qzIhfw?scode=AJEAIQdfAAora6fo54AGYAPQbmACg" target="_blank" rel="noreferrer">打开实践指南</a>
          </article>
          <article class="spill-node has-shot">
            <span class="leap-date editable">05 / 12</span>
            <h3 class="editable">AData 会客厅</h3>
            <p class="editable">平台内分享：分析思路与人机分工，让更多同学理解方法。</p>
            <div class="shot-frame small spill-shot"><img src="assets/shot-adataclaw-sharing.png" alt="AData Claw 分享页封面" loading="lazy"></div>
            <a class="case-link" href="https://going0917.github.io/adataclaw-sharing/" target="_blank" rel="noreferrer">打开分享页</a>
          </article>
          <article class="spill-node has-shot">
            <span class="leap-date editable">成熟后</span>
            <h3 class="editable">平台化输出</h3>
            <p class="editable">成熟 Skill 上架平台，成为可直接调用的预制能力。</p>
            <div class="shot-frame small spill-shot"><img src="assets/shot-adata-marketplace.png" alt="AData Skill 市集上架截图" loading="lazy"></div>
          </article>
        </div>
      ...
      <div class="product-proof-layout">
        ...
        <div class="product-proof-grid">
          <article class="product-proof-card proof-baseline">
            ...
            <a class="case-link" href="https://doc.weixin.qq.com/sheet/e3_AdAAPgadABsBryWmF2nSbm3zGxJ17?scode=AJEAIQdfAAooRTr6thAGYAPQbmACg&tab=ozvv9xAI" target="_blank" rel="noreferrer">打开双周报</a>
          </article>
          <article class="product-proof-card proof-data">
            ...
            <div class="shot-frame product-proof-shot"><img src="assets/shot-prod-full-domain.png" alt="食品饮料爆品拓品机会榜企微表格" loading="lazy"></div>
            <div class="product-proof-copy">
            ...
            <div class="product-proof-result editable"><strong>20,162 SKU</strong> · 4 段业务流 · 3 份报告 + 1 套工具</div>
            <a class="case-link" href="https://doc.weixin.qq.com/sheet/e3_AaEAUgbuAPUCNCB9miVySRbed7ztV?scode=AJEAIQdfAAovwIfDG9AGYAPQbmACg&tab=5yydxlAI" target="_blank" rel="noreferrer">打开拓品榜</a>
          </article>
          <article class="product-proof-card proof-scene">
            ...
            <div class="shot-frame product-proof-shot"><img src="assets/shot-prod-marketing-map.png" alt="鹅选清凉节应季营销地图五大节点" loading="lazy"></div>
            <div class="product-proof-copy">
            ...
            <div class="product-proof-result editable"><strong>11 类目</strong> · 10,601 商品 · 5,333 品牌 · 5 个节点</div>
            <a class="case-link" href="https://winglee777.github.io/q3-category-trend/qingliang/" target="_blank" rel="noreferrer">打开清凉节地图</a>
          </article>
          <article class="product-proof-card proof-decision">
            ...
            <div class="product-proof-dual">
              ...
              <div class="shot-frame product-proof-shot"><img src="assets/shot-prod-tigernut.png" alt="虎坚果单客开品报告" loading="lazy"></div>
            </div>
            <div class="product-proof-copy">
            ...
            <div class="product-proof-links"><a class="case-link" href="https://winglee777.github.io/product-insight-prompt/" target="_blank" rel="noreferrer">打开生成器</a><a class="case-link" href="https://winglee777.github.io/food-category-insight/case-shamo-tigernut.html" target="_blank" rel="noreferrer">打开报告</a></div>
          </article>
        </div>
      </div>`,
    ...
    25: () => `
      <div class="integrated-layout">
        ...
        <div class="force-table">
          ...
          <div class="force-row"><div class="force-name editable"><span class="force-index">03</span>内容 / 直播</div><div class="force-human editable"><strong>选择标杆</strong>：明确该追赶谁、差距在哪里</div><div class="force-ai editable"><strong>批量分析</strong>：14 间头部直播间，提炼人货场与话术标杆</div></div>
    ...
    28: () => `
      <div class="closing-layout">
        ...
        <div class="closing-links">
          ...
          <a class="case-link" href="https://going0917.github.io/ai-ops-showcase/" target="_blank" rel="noreferrer">运营 × AI 全局架构</a>
          <a class="case-link" href="https://going0917.github.io/ai-ops-showcase/townhall-0518/" target="_blank" rel="noreferrer">Townhall 四力实践</a>
          <a class="case-link" href="https://going0917.github.io/adataclaw-sharing/" target="_blank" rel="noreferrer">AData Claw 分享</a>
        </div>
      </div>`,
  };
  ...
  function renderPanel() {
    ...
    const speaker = slide.speaker || [
      `本页核心讲法：${slide.claim}`,
      `当前主画面原料：${slide.body}`,
      "详细讲稿、案例和补充说明请回到 V1.2 三层内容主稿对应页。",
    ];
    const sources = slide.sources || [{ label: "V1.2 三层内容主稿", url: deckData.meta.sourceDocument }];
    const facts = slide.facts || [];
    const needs = slide.needs || ["复杂构图与第三层案例待后续 Agent 补齐"];
